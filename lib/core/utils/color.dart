...
class AppColors {
  static const Color primaryBlue = Color(0xFF003F87); // اللون الأزرق الأساسي للأزرار والـ Headers
  static const Color backgroundLight = Color(0xFFF8F9FA); // الخلفية البيضاء المائلة للرمادي للشاشات
